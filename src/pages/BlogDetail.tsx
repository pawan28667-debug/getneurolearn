      ...
      <div className="mx-auto max-w-3xl">
        ...
        <article className="rounded-3xl border border-border bg-card p-6 shadow-sm">
          ...
          <section className="mt-6 rounded-2xl border border-primary/20 bg-primary/5 p-4">
            <h2 className="text-lg font-semibold text-foreground">Why this article matters</h2>
            <p className="mt-2 text-sm text-muted-foreground">
              This long-form guide is designed to be read as a full study lesson, not a quick quote. Each section explains a practical idea, why it works, and how to apply it during real revision sessions.
            </p>
            <ul className="mt-3 list-disc space-y-1 pl-5 text-sm text-muted-foreground">
              <li>Use the main idea as your daily focus.</li>
              <li>Practice the point with one real example.</li>
              <li>Return to the article whenever you need a fresh study reset.</li>
            </ul>
          </section>
          ...
          <div className="mt-6 space-y-4">
            ...
            {post.points.map((point, index) => (
              <section key={point.heading} className="rounded-2xl border border-border/70 bg-background/80 p-4">
